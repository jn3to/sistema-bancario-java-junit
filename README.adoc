...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/jn3to/sistema-bancario-java-junit/maven[GitHub Workflow Status]
