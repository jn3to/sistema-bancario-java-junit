...
public final class Util {
    /**
     * Construtor privado para evitar que a classe seja instanciada, uma vez que ela não possui
     * atributos e todos os métodos são estáticos.
     */
    private Util() {
        /**/
    }
    ...
    /**
     * Calcula um dígito verificador utilizando o algoritmo <a
     * href="https://pt.wikipedia.org/wiki/Dígito_verificador#Módulo_11">modulo 11</a>.
     *
     * @param numero número para calcular o dígito verificador (em formato como, por exemplo,
     *     dddd-d)
